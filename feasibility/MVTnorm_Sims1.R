...
# 
# This initial version estimates a model without covariates
#   and specifies the covariance matrix directly.
#   
#
# Dependencies:
#   None.
...
tri_probit_vec2param <- function(param) {
  ...
  # Append the upper triangle of Sigma. 
...
# It took a long time but these are some preliminary results:
